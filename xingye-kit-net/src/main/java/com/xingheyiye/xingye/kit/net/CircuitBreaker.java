 ...
 * <p>使用示例：</p>
 * <pre>{@code
 * CircuitBreaker breaker = new CircuitBreaker("inventory-service");
...
public final class CircuitBreaker {
     ...
     */
    public CircuitBreaker(String name, int slidingWindowSize, double failureRateThreshold,
